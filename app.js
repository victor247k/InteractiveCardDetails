...
function DATEfunc() {
    ...
    inputMonth.value = parseInt(inputMonth.value) > 12 ? "12" : parseInt(inputMonth.value) < 10 && inputMonth.value.length < 2 ? `0${inputMonth.value}` : `${inputMonth.value.slice(inputMonth.value.length - 2, inputMonth.value.length)}`;
